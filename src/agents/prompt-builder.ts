...
export const ANALYSIS_JSON_SCHEMA = {
  ...
  required: ["isSignal", "symbol", "side", "entryMin", "entryMax", "stopLoss", "takeProfit", "lot", "riskPercentage", "confidence"],
...
export function buildAnalysisPayload(message: TelegramMessage, signalId: string): string {
  return JSON.stringify({
    ...
    outputSchema: {
      ...
      stopLoss: "positive decimal", takeProfit: "positive decimal",
